...
configurables, generación de código de canje por giro, y sección de canje
con login.
...
- **Configuración**: crear/editar premios, cantidades y probabilidades.
...
## Antes de la feria: cargar los premios reales

1. Abre la app publicada, ve a **Configuración**, inicia sesión.
2. Ahí están los 5 premios de ejemplo que vinieron con el SQL — edítalos
   o bórralos (el botón ✕ los desactiva, no los borra del todo, para no
   perder el historial si ya hay códigos generados).
